...
<link rel="stylesheet" type="text/css" href="Library/css/bootstrap.min.css">
  <link rel="stylesheet" type="text/css" href="stuProfie.css">
...
';  
      ...
      header("location:http://localhost/Student%20Managment%20System/loginStu.php");
     }
    ...
    //   $show=$db->prepare("SELECT * FROM user WHERE  UserName:Name ");
