...
if (isset($_POST['update'])) {
	$username="mostafa";
      ...
      $login=$db->prepare("SELECT * FROM  addmisstion WHERE Email=:Email AND Password=:Password");
      ...
      if ($user->ACTIVATED==="0") {
      	...
      	header("location:http://localhost/Student%20Managment%20System/Addmission.php");
      }
      }
...
<head>
  ...
  <title>Admmision login</title>
</head>
<body style="background-image: url('Images/School1.jpg');color: white;">
  <div class="container">
     <h1 style="color: white;text-align: center;">login Addmision</h1>
     <br><br> 
     <div > 
